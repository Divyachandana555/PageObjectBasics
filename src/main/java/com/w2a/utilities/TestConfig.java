...
public class TestConfig{
	...
	public static String from = "divyapeddakotla@gmail.com";
	public static String password = "chandana1";
	public static String[] to ={"Kissumadanu@gmail.com","Kissumadanu5@gmail.com"};
